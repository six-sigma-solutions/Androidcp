	...
	return (
		<View style={{ flex: 1 }}>
			...
			<View style={styles.buttonSection}>
				<TouchableOpacity style={styles.actionButton} onPress={() => router.push("/solution")}> 
...
const styles = StyleSheet.create({
	...
	title: { textAlign: "center", fontSize: 28, padding: 20, fontWeight: "900", color: "#f10a0a", marginVertical: 20 },
	heroCard: { position: "relative", marginHorizontal: 10, borderRadius: 16, overflow: "hidden", shadowColor: "#000", shadowOpacity: 0.3, shadowRadius: 10 },
	heroImage: { width: "100%", height: 450, opacity: 0.7 },
	heroOverlay: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", padding: 20, justifyContent: "center", backgroundColor: "rgba(0,0,0,0.4)" },
	heroHeading: { fontSize: 20, fontWeight: "700", color: "#fff", marginBottom: 10 },
	heroParagraph: { color: "#ddd", fontSize: 14, lineHeight: 22 },
	visionBlock: { marginVertical: 30, alignItems: "center", paddingHorizontal: 15 },
	sectionImage: { width: "95%", height: 184, borderRadius: 16, marginBottom: 15 },
	visionText: { width: "98%" },
	visionPoint: { flexDirection: "row", alignItems: "flex-start", marginBottom: 10 },
	tick: { color: "red", fontSize: 16, marginRight: 6 },
	pointText: { flex: 1, fontWeight: "700", fontSize: 14, color: "#111", lineHeight: 22, textAlign: "justify" },
	gallerySection: { alignItems: "center", paddingVertical: 30 },
	galleryItem: { alignItems: "center", justifyContent: "center", marginRight: 20 },
	arrow: { fontSize: 60, color: "#0cf938ff", marginTop: 10, textAlign: "center", fontWeight: "bold" },
	galleryTitle: { fontSize: 22, fontWeight: "800", color: "#f10a0a", marginBottom: 20 },
	galleryContainer: { flexDirection: "row", gap: 15, paddingLeft: 75, paddingRight: 75, paddingHorizontal: 10 },
	galleryImage: { width: 250, height: 350, borderRadius: 16, marginRight: 12 },
	buttonSection: { alignItems: "center", marginVertical: 30 },
	actionButton: { backgroundColor: "#f10a0a", paddingVertical: 12, paddingHorizontal: 32, borderRadius: 12, shadowColor: "#f10a0a", shadowOpacity: 0.4, shadowRadius: 6 },
