            ...
            <View style={styles.section}>
                ...
                <View style={styles.points}>
                    <Text style={[styles.point, { color: "#e53935" }]}>
                        Women’s empowerment is not just about equality, it is about unlocking the full potential of humanity.
                    </Text>
                    <Text style={[styles.point, { color: "#1976d2" }]}>
                        Women’s empowerment is not a charity, it is justice, progress and the future.
                    </Text>
                    <Text style={[styles.point, { color: "#2e7d32" }]}>
                       Empowerment is the recognition that women are not behind, not ahead, but standing {"\n"}<Text style={styles.highlight}>shoulder to shoulder.</Text>
                    </Text>
                </View>
            ...
            <View style={styles.section}>
                ...
                <View style={styles.programs}>
                    ...
                    <View style={styles.program}>
                        ...
                        <Text style={styles.programText}>
                            Promoting women’s rights and gender equality through advocacy and community programs.
                        </Text>
...
const styles = StyleSheet.create({
    ...
    headerWrap: { marginVertical: 10 ,backgroundColor:'#047871', borderRadius:8, alignItems:'center', justifyContent:'center' },
    headerText: { fontSize: 30, padding: 10, fontWeight: "700", textAlign: "center", color: "#fff" },
