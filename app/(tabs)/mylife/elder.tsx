  ...
  const sections = [
    {
      ...
      text: `DM represents a rebirth - a movement where elders become independent, earn daily, share wisdom, and feel valuable again. Live with financial confidence. Feel valued and included. Share your wisdom not your worries. Enjoy peace, purpose and pride in your DM life.`,
    },
    {
